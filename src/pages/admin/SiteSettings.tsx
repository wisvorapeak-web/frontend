              ...
              <TabsContent value="contact" className="mt-0">
                <Card className="border border-slate-200 shadow-none rounded overflow-hidden">
                  ...
                  <CardContent className="p-6 space-y-5 italic font-bold">
                    ...
                    <div className="space-y-1.5"><Label className="text-[10px] text-slate-400 uppercase tracking-widest ml-1">WhatsApp Number (include default generic country code e.g. 6561234567, no + )</Label><Input value={settings.whatsapp_number || ''} onChange={e => updateKey('whatsapp_number', e.target.value)} placeholder="6561234567" className="h-10 bg-slate-50 border-slate-200 rounded text-sm transition-none" /></div>
