...
const tiers = [
  { 
    name: 'Platinum Elite', 
    price: '$15,000', 
    benefits: ['Main stage presence', 'Exhibition island booth', '10 free registrations', 'Full-page program ad'],
    icon: Award,
  ...
  { 
    name: 'Gold Premier', 
    price: '$10,000', 
    benefits: ['Technical session sponsor', 'Standard large booth', '6 free registrations', 'Half-page program ad'],
    icon: Target,
  ...
  { 
    name: 'Silver Partner', 
    price: '$5,000', 
    benefits: ['Supporting sponsor logo', 'Compact booth', '3 free registrations', 'Quarter-page ad'],
    icon: Zap,
...
export default function SponsorshipPage() {
  return (
    <PageLayout 
      ...
      subtitle="Establish your brand at the forefront of polymer science and materials engineering."
    >
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
           <div className="space-y-6">
              ...
              <div className="space-y-4">
                 {[
                   { t: 'Strategic Visibility', d: 'Showcase your technology to 4,200+ decision makers and elite researchers.', i: Globe },
                   { t: 'Lead Generation', d: 'Interactive exhibition floor designed to maximize visitor engagement.', i: Building2 },
                   { t: 'Thought Leadership', d: 'Opportunities to sponsor keynotes and specialized technical tracks.', i: FileCheck }
                 ].map((item, i) => (
